...
public class DoctorServlet2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		String name=(String)ses.getAttribute("doc-name");
		String pass=(String)ses.getAttribute("doc-pass");
		...
		pw.println("<div class=\"d-flex justify-centre border border-4 border-success\">\r\n"
				...
				+ "	<a href="+res.encodeUrl("AllotedPatient")+"><button class='btn btn-warning m-4 w-100'>CHECK ALLOTED PATIENT FOR ME </button></a>"
				+ ""
				+ "    \r\n"
				+ "      <br>\r\n"
